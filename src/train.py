...
if __name__ == '__main__':
    ...
    (
        ...
        config.dev_file_path, config.dev_elmo_path, config.dev_flair_path
    )
    ...
    (
        ...
        config.test_file_path, config.test_elmo_path, config.test_flair_path
    )
    ...
    if config.use_full:
        ...
        dev_dataset = CDRDataset(dev_all_doc_token_ids,
                          dev_all_in_nodes_idx,
                          dev_all_out_nodes_idx,
                          dev_all_in_edge_label_ids,
                          dev_all_out_edge_label_ids,
    ...
    test_dataset = CDRDataset(test_all_doc_token_ids,
                        test_all_in_nodes_idx,
                        test_all_out_nodes_idx,
                        test_all_in_edge_label_ids,
                        test_all_out_edge_label_ids,
    ...
    if dev_dataset is not None:
        dev_loader = DataLoader(dev_loader, batch_size = config.batch_size, shuffle = False, collate_fn = dev_dataset.collate_fn)
